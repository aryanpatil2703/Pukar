...
// ============================================
const SYSTEM_PROMPT = `You are a phone call intent classifier for Microsoft.

The caller was asked: "Are you a team member or a client of Microsoft?"

Classify the caller's response into exactly ONE of these intents:
- "available": The caller confirmed they are associated with Microsoft (employee, client, or willing to talk)
